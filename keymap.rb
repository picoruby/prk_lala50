...
kbd.add_layer :default, %i[
  ...
  KC_TAB   KC_A    KC_S    KC_D    KC_F    KC_G      KC_MUTE  KC_H      KC_J    KC_K     KC_L     KC_SCLN  KC_BSPACE
  KC_LSFT  KC_Z    KC_X    KC_C    KC_V    KC_B      KC_VOLD  KC_N      KC_M    KC_COMMA KC_DOT   KC_SLASH KC_RSFT
...
kbd.add_layer :raise, %i[
  ...
  KC_TAB   KC_LABK KC_LCBR KC_LBRC KC_LPRN KC_QUOTE  KC_MUTE  KC_LEFT   KC_DOWN KC_UP    KC_RIGHT KC_UNDS  KC_PIPE
  KC_LSFT  KC_RABK KC_RCBR KC_RBRC KC_RPRN KC_DQUO   KC_VOLD  KC_TILD   KC_BSLS KC_COMMA KC_DOT   KC_SLASH KC_RSFT
  KC_BTN1  KC_BTN2 KC_LGUI KC_LALT KC_LCTL LOWER_SPC RGB_TOG  RAISE_ENT IME     KC_LEFT  KC_DOWN  KC_UP    KC_RIGHT
]
kbd.add_layer :lower, %i[
  KC_ESC   KC_1    KC_2    KC_3    KC_4    KC_5      KC_VOLU  KC_6      KC_7    KC_8     KC_9     KC_0     KC_EQUAL
  KC_TAB   KC_LABK KC_LCBR KC_LBRC KC_LPRN KC_QUOTE  KC_MUTE  KC_LEFT   KC_6    KC_5     KC_4     KC_UNDS  KC_BSPACE
  KC_LSFT  KC_RABK KC_RCBR KC_RBRC KC_RPRN KC_DQUO   KC_VOLD  KC_NO     KC_3    KC_2     KC_1     KC_SLASH KC_COMMA
  KC_BTN1  KC_BTN2 KC_LGUI KC_LALT KC_LCTL LOWER_SPC RGB_TOG  RAISE_ENT KC_0    KC_LEFT  KC_DOWN  KC_UP    KC_RIGHT
]
